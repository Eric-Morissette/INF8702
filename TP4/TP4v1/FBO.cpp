...
void CFBO::Init( int w, int h, int format )
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, m_TextureW, m_TextureH, 0, m_InternalFormat, GL_UNSIGNED_BYTE, 0);
    ...
    GLenum m_Target[1] = { GL_COLOR_ATTACHMENT0 };
    glDrawBuffers(1, m_Target);
